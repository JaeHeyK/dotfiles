...
highlight DiffDelete     ctermfg=0    ctermbg=1   cterm=bold
highlight DiffText       ctermfg=0    ctermbg=3   cterm=bold

" Invert selected lines in visual mode
highlight Visual         ctermfg=0    ctermbg=15   cterm=none
...
if &background == "light"
  ...
  highlight CursorLineNr ctermfg=11   term=NONE    cterm=NONE
  highlight CursorLine                ctermbg=60   cterm=NONE    term=NONE
